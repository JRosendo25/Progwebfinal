...
<head>
  ...
  <title>libreria RF- Contacto</title>
        ...
        <div class="row gy-4 d-flex justify-content-end">
          ...
          <div class="col-lg-5" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="info-item d-flex">
              ...
              <div>
                <h4>Location:</h4>
                <p>Calle A, 108  San Pedro de Marcoris, SPM  2100</p>
              </div>
            </div><!-- End Info Item -->
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="250">
            ...
            <form action="MandarComentario.php" method="post" role="form" class="php-email-form">
              <div class="row">
              ...
              <div class="form-group mt-3">
                <input type="date" class="form-control" name="date" id="subject" placeholder="Fecha" required>
              </div>
              <div class="form-group mt-3">
              ...
              <div class="my-3">
                ...
                <div class="sent-message">Mensaje enviado correctamente!</div>
              </div>
